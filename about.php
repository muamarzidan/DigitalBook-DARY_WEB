        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="mynavbar">
            ...
            <form class="d-flex">
              ...
              <button class="btn btn-primary" type="button" style="background-color: #4A4E69; border-style: hidden;"><a href="formlogin.php" style="text-decoration: none; color: #FFFFFF;">Login</a></button>
            </form>
          </div>
        </div>
      </nav>
